...
const extractRules  = require('./extract_styles');
...
module.exports = class CSSInliner {
  ...
  constructor(options) {
    const stylesheets = new Stylesheets(options);
  ...
  // { dom, stylesheets } -> promise({ dom, rules })
  //
  ...
  static extractRules(context) {
    ...
    const stylesheets = context.stylesheets;
    return extractRules(dom, stylesheets);
  }
